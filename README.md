# FlightFilteringModule
Модуль, который занимается фильтрацией наборов перелетов согласно различным правилам
---------
# Техническое задание #
...
**departureUntilNow()** рейсы, у которых вылет до текущего момента времени
**arrivalBeforeDeparture()** рейсы, у которых дата прилета раньше даты вылета
**timeOnTheGroundMore2Hours()** рейсы, у которых общее время, проведённое на земле превышает два часа
## Разработчик ##
**Kozyar Oxana**
## Язык ##
**Java**
